...
const patterns = {
   ...
   async asriel (
               ...
               while (controller.active && findex < fcount) {
                  ...
                  const firework = new CosmosAnimation({
                     ...
                     if (this.position.y <= tY) {
                        ...
                        sf(sounds.boom.instance(renderer, { offset: 0.2 })).rate.value = big ? 0.8 : 1.6;
               ...
               while (controller.active && i < (hardmode ? 150 : 100)) {
                  ...
                  if (l-- === 0) {
                     ...
                     renderer.pause(hardmode ? 800 : 1000).then(async () => {
                        ...
                        const snd2 = sf(sounds.boom.instance(renderer, { offset: 0.16 }));
                        snd2.rate.value = 0.8;
         ...
         case 9: {
            ...
            turnPromise = (async () => {
               ...
               while (controller.active && round < rounds) {
                  ...
                  sf(sounds.boom.instance(renderer, { offset: 0.2 })).rate.value = 1.6;
                  shake();
                  if (!controller.active) {
                     return;
                  }
      ...
      if (hy.active) {
         ...
         if (da) {
            battler.music = da.instance(renderer);
