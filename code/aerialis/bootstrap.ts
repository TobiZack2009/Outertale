...
items.register('filament_use1', {
   ...
   sell1: 8,
   sell2: 24,
   text: { ...text.i_filament, ...text.i_filament_use1 }
});
...
items.register('filament_use2', {
   ...
   sell1: 8,
   sell2: 16,
   text: { ...text.i_filament, ...text.i_filament_use2 }
});
...
items.register('filament_use3', {
   ...
   sell1: 8,
   sell2: 12,
   text: { ...text.i_filament, ...text.i_filament_use3 }
});
...
items.register('filament_use4', {
   ...
   sell1: 8,
   sell2: 10,
   text: { ...text.i_filament, ...text.i_filament_use4 }
});
